...
<html>
	...
	<body>
		<section class="team-single-page test" style="min-height: 440px;">
			<span class="control prev hide-for-small"><?php echo lb_print_next_prev_team('PREV'); ?></span>
			<div class="row">
				<?php /* BEGIN: Content */?>
			...
			<span class="control next hide-for-small"><?php echo lb_print_next_prev_team('NEXT'); ?></span>
		</section>
